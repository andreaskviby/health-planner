...
export default function ProfileSetup({ onComplete }: ProfileSetupProps) {
  ...
  return (
    <div className="min-h-full min-h-screen min-h-[100vh] min-h-[100dvh] bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex items-center justify-center p-4 pt-safe pb-safe">
